  ...
  return (
    <div className="flex flex-col gap-4 max-h-[34rem] scroll-smooth scrollbar">
      {AccountList.length === 0 ? (
        <span>
          Currently simulation works only for Blinks which have default href for
          their post actions, i.e.:
            ...
            <div className="flex flex-col gap-1 p-3 overflow-auto scroll-smooth scrollbar">
              {Logs && Logs.length > 0 ? (
                ...
                <p className="text-red-500">
                  Simulation failed, either you don&apos;t have enough balance
                  in your wallet or the transaction is not valid.
                </p>
              )}
            </div>
          </div>
